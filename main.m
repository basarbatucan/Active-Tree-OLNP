...
if (~isfile(out_hyper)) || (forced_parameter_tuning_flag == 1)
    ...
    node_loss_constant = model.node_loss_constant_;
    entropy_th = model.entropy_th_;
    explore_pr = model.explore_pr_;
    % save hyper-parameters
    save(out_hyper, 'eta_init', 'beta_init', 'gamma', 'sigmoid_h', 'lambda', 'tree_depth', 'split_prob', 'node_loss_constant', 'entropy_th', 'explore_pr');
end
